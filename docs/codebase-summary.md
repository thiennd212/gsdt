...
| **Frontend Components** | 60+ feature modules | Admin pages (including catalogs CRUD), user profiles, dashboards, workflows, investment projects (Domestic/ODA/PPP/DNNN/NĐT/FDI) |
...
| **Database Entities** | 200+ | SQL Server 2022 + EF Core 10 + Always Encrypted (PII); 46 InvestmentProjects entities in "investment" schema (Domestic/ODA/PPP/DNNN/NĐT/FDI project types) |
