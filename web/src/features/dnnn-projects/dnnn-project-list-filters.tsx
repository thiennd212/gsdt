...
interface DnnnProjectListFiltersProps {
  search: string;
...
// DnnnProjectListFilters — 5 filters: search, CQCQ, investorName, status, province.
export function DnnnProjectListFilters({
  search,
  onSearchChange,
  filterValues = {},
  onFilterChange,
  actions,
}: DnnnProjectListFiltersProps) {
  ...
  return (
    <Flex wrap gap={8} align="center" style={{ padding: '12px 24px' }}>
      ...
      />
      <Select
        data-testid="dnnn-select-competent-authority"
      ...
      />
      <Input
        data-testid="dnnn-input-investor-name"
      ...
      />
      <Select
        data-testid="dnnn-select-status"
      ...
      />
      <Select
        data-testid="dnnn-select-province"
        placeholder="Tỉnh/TP"
        allowClear
        showSearch
