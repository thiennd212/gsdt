...
import { NdtTab1GeneralInfo } from './tabs/ndt-tab1-general-info';
import { NdtTab2Implementation } from './tabs/ndt-tab2-implementation';
...
// NdtProjectTabsContainer — 5-tab form container for NĐT projects.
// NO Tab HĐ NĐT (investor contract), NO TKTT (design estimates).
export function NdtProjectTabsContainer({ projectId, mode }: TabsContainerProps) {
