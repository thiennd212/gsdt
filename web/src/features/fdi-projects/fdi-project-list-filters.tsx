...
interface FdiProjectListFiltersProps {
  search: string;
...
// FdiProjectListFilters — 5 filters: search, CQCQ, investorName, status, province.
export function FdiProjectListFilters({
  search,
  onSearchChange,
  filterValues = {},
  onFilterChange,
  actions,
}: FdiProjectListFiltersProps) {
  ...
  return (
    <Flex wrap gap={8} align="center" style={{ padding: '12px 24px' }}>
      ...
      />
      <Select
        data-testid="fdi-select-competent-authority"
      ...
      />
      <Input
        data-testid="fdi-input-investor-name"
      ...
      />
      <Select
        data-testid="fdi-select-province"
        placeholder="Tỉnh/TP"
        allowClear
        showSearch
