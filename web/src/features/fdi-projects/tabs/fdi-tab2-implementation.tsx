...
import { useAddFdiBidPackage, useDeleteFdiBidPackage, useFdiProject } from '../fdi-project-api';
...
export function FdiTab3Implementation({ projectId, mode }: Tab3Props) {
  ...
  const addBid = useAddFdiBidPackage();
  const deleteBid = useDeleteFdiBidPackage();
  ...
  const bidColumns: ColumnsType<FdiBidPackageDto> = [
