...
/// <summary>
/// WebApplicationFactory wired to Testcontainers SQL Server for Identity integration tests.
/// Overrides:
///   - DB connection strings → Testcontainers instance
///   - Auth → TestAuthHandler (bypasses JWT validation in tests)
///   - Background services → disabled to avoid Hangfire/MassTransit noise
/// </summary>
