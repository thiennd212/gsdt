...
namespace GSDT.Organization.Integration.Tests.Fixtures;

/// <summary>
/// Spins up a SQL Server 2022 container for the duration of the test collection.
/// Shared across all Organization integration tests — one container per collection.
/// </summary>
...
/// <summary>xUnit collection definition — all Organization integration tests share one SQL Server container.</summary>
[CollectionDefinition(CollectionName)]
public sealed class SqlServerCollection : ICollectionFixture<SqlServerFixture>
{
    public const string CollectionName = "OrganizationIntegration";
}
