...
/// Shared across all Notifications integration tests — one container per collection.
/// </summary>
...
/// <summary>xUnit collection definition — all Notifications integration tests share one SQL Server container.</summary>
[CollectionDefinition(CollectionName)]
public sealed class SqlServerCollection : ICollectionFixture<SqlServerFixture>
{
    public const string CollectionName = "NotificationsIntegration";
}
