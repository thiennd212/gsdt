...
public sealed class UpdateNdtProjectCommandValidator
    : AbstractValidator<UpdateNdtProjectCommand>
{
    public UpdateNdtProjectCommandValidator()
    {
        RuleFor(x => x.Id).NotEmpty();
        RuleFor(x => x.RowVersion).NotEmpty().WithMessage("RowVersion la bat buoc.");
