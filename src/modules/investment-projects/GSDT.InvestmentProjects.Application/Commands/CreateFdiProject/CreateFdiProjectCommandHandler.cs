...
/// <summary>
/// Creates a new FdiProject aggregate, validates code uniqueness, and persists via repository.
/// </summary>
public sealed class CreateFdiProjectCommandHandler(
    IInvestmentProjectRepository repository,
    ITenantContext tenantContext)
    : IRequestHandler<CreateFdiProjectCommand, Result<Guid>>
{
    public async Task<Result<Guid>> Handle(
        CreateFdiProjectCommand request,
