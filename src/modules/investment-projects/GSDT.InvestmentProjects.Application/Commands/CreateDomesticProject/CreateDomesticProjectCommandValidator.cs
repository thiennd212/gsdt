...
public sealed class CreateDomesticProjectCommandValidator
    : AbstractValidator<CreateDomesticProjectCommand>
{
    public CreateDomesticProjectCommandValidator()
    {
        ...
        // PMU email format when provided
