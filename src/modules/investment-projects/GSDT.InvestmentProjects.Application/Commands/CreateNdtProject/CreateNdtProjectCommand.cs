...
/// <summary>Creates a new NĐT (private domestic investor) project aggregate. Returns the new project Id.</summary>
public sealed record CreateNdtProjectCommand(
    string ProjectCode,
    string ProjectName,
