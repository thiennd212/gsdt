...
public sealed class CreateNdtProjectCommandValidator
    : AbstractValidator<CreateNdtProjectCommand>
{
    public CreateNdtProjectCommandValidator()
    {
        ...
        // Capital validation: Total == CSH + ODA + TCTD
        RuleFor(x => x.PrelimTotalInvestment)
