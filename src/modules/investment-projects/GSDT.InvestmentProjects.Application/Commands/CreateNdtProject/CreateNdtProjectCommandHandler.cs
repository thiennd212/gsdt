namespace GSDT.InvestmentProjects.Application.Commands.CreateNdtProject;

/// <summary>
/// Creates a new NdtProject aggregate, validates code uniqueness, and persists via repository.
/// </summary>
public sealed class CreateNdtProjectCommandHandler(
    IInvestmentProjectRepository repository,
    ITenantContext tenantContext)
    : IRequestHandler<CreateNdtProjectCommand, Result<Guid>>
{
    public async Task<Result<Guid>> Handle(
        CreateNdtProjectCommand request,
