...
/// <summary>
/// Investment decision record for NĐT projects (initial or adjustment).
/// Capital breakdown: CSH + ODA loan + TCTD loan (same as DNNN).
/// </summary>
public sealed class NdtInvestmentDecision : AuditableEntity<Guid>, ITenantScoped
{
    ...
    // Navigation
    public NdtProject Project { get; set; } = default!;

    private NdtInvestmentDecision() { } // EF Core

    public static NdtInvestmentDecision Create(
