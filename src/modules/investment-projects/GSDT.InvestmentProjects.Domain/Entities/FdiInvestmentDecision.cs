...
/// <summary>
/// Investment decision record for FDI projects (initial or adjustment).
/// Capital breakdown: CSH + ODA loan + TCTD loan (same as NĐT/DNNN).
/// </summary>
public sealed class FdiInvestmentDecision : AuditableEntity<Guid>, ITenantScoped
{
    ...
    // Navigation
    public FdiProject Project { get; set; } = default!;

    private FdiInvestmentDecision() { } // EF Core

    public static FdiInvestmentDecision Create(
