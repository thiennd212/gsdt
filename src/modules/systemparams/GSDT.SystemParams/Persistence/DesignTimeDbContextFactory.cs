...
/// </summary>
internal sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<SystemParamsDbContext>
{
    public SystemParamsDbContext CreateDbContext(string[] args)
    {
        ...
        var opts = new DbContextOptionsBuilder<SystemParamsDbContext>()
            .UseSqlServer(connStr, sql =>
                sql.MigrationsHistoryTable("__EFMigrationsHistory", "config"))
            .Options;

        return new SystemParamsDbContext(opts, NullTenantContext.Instance);
    }
}
